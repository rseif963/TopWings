...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        { name: "Rhodah Wanjiku", address: "Nairobi, Kenya", image: assets.testimonial_image_3, testimonial: "Top Wings made my trip so much easier. The car was delivered right to my door, and the customer service was fantastic!" },
        { name: "Farhiya Mohamed", address: "Nairobi, Kenya", image: assets.testimonial_image_1, testimonial: "I highly recomend Top Wings! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent services" }
    ];
